...
"""
def LM_optimize(target_function,x_array,x_name,experiment,uncertainty,params,kwargs,startpoints):
    residual = make_residual(target_function,x_array,x_name,experiment,uncertainty,params,kwargs)
    ...
    for x0 in startpoints:
        try:
            ...
            result = least_squares(residual_nostop,x0=e.params,method='lm',ftol=0, xtol=0, gtol=0,max_nfev=1)
