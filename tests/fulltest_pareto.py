...
### Joint fit ###
jointstart = np.array(result.x)#dynamic
jointstart_mag = np.array(result_mag.x)#dynamic
...
jointstart_nuc_filtered = jointstart[mask_params_nuc]#dynamic
...
deleted_nuc_values = jointstart[mask_params_nuc_del]#dynamic
